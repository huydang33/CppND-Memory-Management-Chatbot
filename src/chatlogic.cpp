...
ChatLogic::ChatLogic()
{
    ...
    // create instance of chatbot => Create local chatbot in LoadAnswerGraphFromFile()
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // Each GraphNode will exclusively own its outgoing GraphEdges
    ...
    SetChatbotHandle(&chatBot); // update chatBot for chatLogic 
    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
